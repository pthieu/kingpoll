...
$(document).ready(function(){
    ...
    socket.on('listpoll', function (poll) {
        for(var i in poll){
            ...
            $('#polls-wrap').append('<td class="embed-wrap" colspan="'+(th_colspan+1)+'"><div class="polldesc" style="display: none" poll-id='+poll[i].p_id+" "+((_embeddata)?("embed-data=\""+_embeddata+"\""):"")+'>'+tmpdesc+'</div></td>');
        }
